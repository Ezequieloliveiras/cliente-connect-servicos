        ...
        <div style={{backgroundColor:'#fafafa'}}>
            ...
            <Container>
                <Box sx={{marginBottom:'50px', marginTop:'50px'}}>
                    ...
                    <p style={{color:'grey'}}>Bem-vindo(a) a nossa página de suporte. Estamos aqui para ajudá-lo!</p>
                ...
                <SupportContent>
                    ...
                    <Section>
                        <h2 style={{color:'rgb(12, 60, 96)', textAlign: 'center', marginBottom: '40px' }}>Alguns dos atendimentos que realizamos</h2>
                        <form>
                            <Topic>
